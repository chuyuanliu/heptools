...
class CBRNG(ABC, Generic[_KeyT]):
    ...
    def choice(
        ...
        a : ~numpy.typing.ArrayLike or int
            If an ndarray, a random sample is generated by choosing from the first dimension. If an int, the random sample is generated as if it were np.arange(a).
